...
public class TestState : State
{
    ...
    {
        font = Globals.Content.Load<SpriteFont>("Fonts/testFont");

        btn = new Button(new Vector2(50,50),new Vector2(100,50), font, "Click ", new Color(255,255,255) ,new Color(255,0,0),new Color(0,255,0),new Color(0,0,255));
        ...
        btn3 = new Button(new Vector2(100,150),new Vector2(50,100), font, "Click ", new Color(255,255,255), new Color(196,32,196),new Color(150,32,150),new Color(0,0,255));
    }
